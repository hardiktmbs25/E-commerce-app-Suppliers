...
class CustomerModel extends HiveObject {
  ...
  @HiveField(4)  final String? alternatePhone;
  @HiveField(5)  final String address;
  @HiveField(6)  final String? landmark;
  @HiveField(7)  final String? routeId;
  @HiveField(8)  final String? routeName;
  ...
  CustomerStatus get status => CustomerStatus.values.firstWhere(
          (e) => e.name == statusStr, orElse: () => CustomerStatus.active);
