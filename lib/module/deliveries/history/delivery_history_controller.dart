// lib/module/deliveries/history/delivery_history_controller.dart
...
class DeliveryHistoryController extends GetxController {
  ...
  String get activeFilterLabel {
    final parts = <String>[];
    if (statusFilter.value.isNotEmpty) parts.add(StringExtensions(statusFilter.value).capitalize);
            ...
            children: ['', 'pending', 'delivered', 'missed', 'cancelled'].map((s) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: Text(s.isEmpty ? 'All' : StringExtensions(s).capitalize,
