      ...
      body: Column(children: [
        ...
        Obx(() => Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
            _SummaryItem('Total', '${ctrl.allDeliveries.length}', AppColors.primary),
            _Divider(),
            _SummaryItem('Delivered', '${ctrl.deliveredCount}', AppColors.success),
            _Divider(),
            _SummaryItem('Pending', '${ctrl.pendingCount}', AppColors.warning),
            _Divider(),
            _SummaryItem('Missed', '${ctrl.missedCount}', AppColors.error),
          ]),
        )),
          ...
          child: Obx(() {
            ...
            if (ctrl.filteredDeliveries.isEmpty) {
              return EmptyState(
                ...
                actionLabel: ctrl.searchQuery.value.isNotEmpty ? 'Clear Search' : null,
                onAction: ctrl.searchQuery.value.isNotEmpty ? ctrl.clearSearch : null,
              );
            }
                      ...
                      endActionPane: ActionPane(
                        ...
                        children: [
                          if (d.isPending) ...[
                            ...
                            SlidableAction(
                              onPressed: (_) =>
                                  ctrl.showMarkWithNotesDialog(d, DeliveryStatus.missed),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            Expanded(child: Column(
              ...
              children: [
                Row(children: [
                  Expanded(child: Text(delivery.customerName,
          ...
          if (delivery.notes != null && delivery.notes!.isNotEmpty)
            Padding(
              ...
              child: Row(children: [
                const Icon(Icons.notes_rounded, size: 12, color: AppColors.textHint),
                const SizedBox(width: 4),
                Expanded(child: Text(delivery.notes!,
