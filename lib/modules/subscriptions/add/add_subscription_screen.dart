              ...
              child: Obx(() {
                ...
                return DropdownButtonFormField<PlanModel>(
                  ...
                  items: plans.map((p) => DropdownMenuItem<PlanModel>(
                    value: p,
                    child: Text('${p.name} (₹${p.pricePerDelivery.toStringAsFixed(0)})', overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 14, fontFamily: 'Poppins', fontWeight: FontWeight.w600)),
                  )).toList(),
