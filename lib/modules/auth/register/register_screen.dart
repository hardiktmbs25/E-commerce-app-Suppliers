        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => controller.selectedService.value == 'custom'
                  ? Padding(
                      padding: const EdgeInsets.only(top: 16),
                      child: AppTextField(
                        label: 'Enter Service Name',
                        hint: 'e.g. Laundry, Pharmacy',
                        controller: controller.otherServiceCtrl,
                        prefix: const Icon(Icons.edit_note_rounded, size: 18, color: AppColors.textHint),
                      ),
                    )
                  : const SizedBox()),
              const SizedBox(height: 16),
